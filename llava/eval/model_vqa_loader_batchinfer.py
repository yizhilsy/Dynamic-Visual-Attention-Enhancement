...
def eval_model(args):
    ...
    model, processor, tokenizer, image_processor = load_lora_finetuned_model(base_model_name_or_path=model_path, device=args.device, torch_dtype=torch.bfloat16, lora_model_name_or_path=lora_path)
    ...
    data_loader = create_data_loader(questions, args.image_folder, processor, model.config, args.batch_size)
