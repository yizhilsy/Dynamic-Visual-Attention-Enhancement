...
class LlavaMetaForCausalLM(ABC):
    ...
    """
    pasta_mm
    The return value of `image_position_mask` has been added to identify which positions in the input sequence correspond to the image patch.
    """
